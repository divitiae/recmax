function CScoreBoard(oParentContainer) {
    ...
    this.createStar = function() {
        ...
        var oData = {
            ...
            frames: {
                width: oSpriteBest.width / 2,
                height: oSpriteBest.height,
                regX: (oSpriteBest.width / 2) / 2,
                regY: oSpriteBest.height / 2
            },
            animations: {
                normal: [0],
                active: [1]
    ...
    this.refreshTextBestScore = function(iScore, bAnim) {
        ...
        if (bAnim) {
            ...
            createjs.Tween.get(_oBestLight, {
                override: true
            }).to({
                    alpha: 1
                },
